# Generated by Django 4.1 on 2023-06-16 07:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salesperson', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='DB_app.salespeople')),
                ('store', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='DB_app.physicalstores')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DB_app.customers')),
                ('salespeople', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='DB_app.salespeople')),
                ('store_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DB_app.physicalstores')),
            ],
        ),
        migrations.CreateModel(
